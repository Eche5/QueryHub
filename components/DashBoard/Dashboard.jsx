...
export default function Dashboard() {
  ...
  const searchSeminarByName = async () => {
  ...
  return (
    <PersistLogin>
      <section className=" bg-white dark:bg-[#0D0D0D] h-screen dark:text-white text-black">
        ...
        <section
          className=" pt-40 flex flex-col items-center gap-8 bg-white dark:bg-[#0D0D0D]"
          onClick={() => {
              ...
              >
                ...
                <div className="  flex items-center gap-2">
                  <svg
                    ...
                    strokeWidth="1.5"
                    stroke="currentColor"
                    className="size-6 hover:to-blue-600 cursor-pointer text-blue-500"
                    onClick={() => {
                  ...
                  <svg
                    ...
                    strokeWidth="1.5"
                    stroke="currentColor"
                    className="size-6 hover:text-red-600 cursor-pointer text-red-800"
                  ...
                  <svg
                    ...
                    strokeWidth="1.5"
                    stroke="currentColor"
                    className="size-6 hover:text-green-500 cursor-pointer text-green-500"
                    onClick={() => {
